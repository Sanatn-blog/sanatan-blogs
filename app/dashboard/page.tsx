  ...
  return (
    <div className="min-h-screen bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        {/* Header */}
        <div className="bg-gray-800 rounded-2xl shadow-xl p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
            <div className="flex items-center space-x-3 sm:space-x-4">
              <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full overflow-hidden bg-gradient-to-r from-orange-500 to-pink-500 flex items-center justify-center">
                {user.avatar ? (
                  <Image
                    src={user.avatar}
                    alt={user.name}
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
              ...
              <button
                ...
                className="flex items-center space-x-2 px-3 sm:px-4 py-2 text-gray-400 hover:text-white transition-colors text-sm"
              >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          <Link href="/write-blog">
            <div className="bg-gray-800 rounded-2xl shadow-xl p-4 sm:p-6 hover:shadow-2xl transition-all duration-300 cursor-pointer border-2 border-transparent hover:border-orange-500/30">
              <div className="flex items-center space-x-3 sm:space-x-4">
          ...
          <Link href="/dashboard/blogs">
            <div className="bg-gray-800 rounded-2xl shadow-xl p-4 sm:p-6 hover:shadow-2xl transition-all duration-300 cursor-pointer border-2 border-transparent hover:border-blue-500/30">
              <div className="flex items-center space-x-3 sm:space-x-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-900/30 rounded-full flex items-center justify-center">
        ...
        <div className="mt-6 sm:mt-8 bg-gray-800 rounded-2xl shadow-xl p-4 sm:p-6 lg:p-8">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            {stats.totalBlogs > 0 && (
              <div className="flex items-center space-x-3 sm:space-x-4 p-3 sm:p-4 bg-gray-700 rounded-xl">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-green-900/30 rounded-full flex items-center justify-center">
