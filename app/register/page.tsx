  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-pink-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        {/* Registration Method Toggle - Commented out for now */}
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
          ...
          {/* Email Registration - Always show this now */}
          ...
          {/* Phone Registration - Commented out for now */}
          {/* {registerMethod === 'phone' && (
          ...
          {/* Social Registration Buttons - Commented out for now */}
