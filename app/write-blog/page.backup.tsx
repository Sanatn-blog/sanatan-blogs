...
//               ? "✏️ Blog updated and saved as draft!"
...
//             <div
//               className="absolute inset-0 w-16 h-16 border-4 border-orange-600 border-t-transparent rounded-full animate-spin mx-auto"
...
//                     </p>
//                     <p className="text-gray-400 text-sm">
//                       ⏱️ ~{Math.ceil((formData.content || "").length / 1000)}{" "}
//                       min read
//                     </p>
//                   </div>
//                 </div>
...
//                     {formData.content ||
//                       "✨ Your amazing content will be displayed here..."}
//                   </div>
//                 </article>
//               </div>
//             )}
...
//                   ) : (
//                     <p className="text-gray-500 text-sm mt-3">
//                       ✨ Tags help categorize your content and improve
//                       discoverability
//                     </p>
//                   )}
//                 </div>
...
//                 💡 Tip: Use the toolbar buttons for quick formatting or learn
//                 markdown syntax for more control.
//               </p>
//             </div>
//           </div>
//         </div>
