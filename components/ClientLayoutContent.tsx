...
export default function ClientLayoutContent({ children }: ClientLayoutContentProps) {
  ...
  const hideNavbarPages = ['/login', '/register', '/admin', '/admin/users', '/admin/settings', '/admin/content', '/admin/contacts', '/admin/super-admin', '/dashboard', '/dashboard/blogs', '/dashboard/bookmarks'];
